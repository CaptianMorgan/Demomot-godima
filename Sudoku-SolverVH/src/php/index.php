...
<body>
    ...
    <?php if(isset($_SESSION['pseudo']))
        echo "<input type='hidden' id='sessionPseudo' name='sessionPseudo' value='".$_SESSION['pseudo']."'/>";
    ...
    <nav>
        <a href="index.php"><button class="mui-btn mui-btn--primary" >Jeu</button></a>
        <a href="index.php?page=score&difficulty=Extrêmement Facile""><button class="mui-btn mui-btn--primary">Score</button></a>
    </nav>
    <section>
        <?php
        if(isset($_GET['page'])) {
